...
```javascript
javascript:(function(brands,tags,brand,tag){!function(a,b){function c(a,b){var c,d;return b.forEach(function(b){c=a.length,b.substr(0,c)==a&&(d=b)}),d}a||(a=prompt("Choose brand\n[ "+brands.join(" | ")+" ]\n\n(leave it blank for '"+brands[0]+"')")||brands[0]),b||(b=prompt("Choose tag\n[ "+tags.join(" | ")+" ]\n\n(leave it blank for '"+tags[0]+"')")||tags[0]),-1===brands.indexOf(a)&&(a=c(a,brands)||a),-1===tags.indexOf(b)&&(b=c(b,tags)||b);var d=["https://rawgit.com/VenereDotCom/FibOS/",b,"/public/fibos-latest-",a,".min.js"].join(""),e=document.createElement("script");e.type="text/javascript",e.src=d,document.getElementsByTagName("head")[0].appendChild(e),console.log("loaded",d)}(brand,tag);}(["hotels","venere"],["latest","staging"],null,null));
```
